...
class MainActivity : BaseActivity() {
    ...
    // 未被选中的图标
    private val mIconUnSelectIds = intArrayOf(R.drawable.tab_icon_home_normal, R.drawable.tab_icon_news_normal/*, R.mipmap.ic_home_normal, R.mipmap.ic_discovery_normal, R.mipmap.ic_hot_normal, R.mipmap.ic_mine_normal*/)
    // 被选中的图标
    private val mIconSelectIds = intArrayOf(R.drawable.tab_icon_home_selected, R.drawable.tab_icon_news_selected/*, R.mipmap.ic_home_selected, R.mipmap.ic_discovery_selected, R.mipmap.ic_hot_selected, R.mipmap.ic_mine_selected*/)
